...
function delete_directory_tree(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_directoryOperations\
    // delete_directory_tree(
    //      $tree_root_dir                  ,
    //      $question_check_root = TRUE
    //      )
    ...
    // descendants.
    //
    // $question_check_root indicates whether we should check if the specified
    // root directory exists (before doing anything).
    //
    // RETURNS
    //      o   On SUCCESS!
    //          - - - - - -
