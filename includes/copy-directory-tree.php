...
// *****************************************************************************
        ...
        namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_directoryOperations ;
...
function copy_directory_tree(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_directoryOperations\copy_directory_tree(
    //      $from_dirspec                   ,
    //      $to_dirspec                     ,
    //      $question_strict = TRUE         ,
    //      $question_overwrite = FALSE     ,
...
Detected in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_directoryOperations\\copy_directory_tree()
EOT;
...
function copy_directorys_descendants(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_directoryOperations\copy_directorys_descendants(
    //      $from_dirspec                   ,
    //      $to_dirspec                     ,
    //      $question_strict = TRUE         ,
    //      $question_overwrite = FALSE     ,
...
Detected in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_directoryOperations\\copy_directorys_descendants()
EOT;
