...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_arrayStorage ;
...
function load_array_from_basepress_dataset(
    ...
    $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressDatasets\load(
                    $basepress_dataset_handle
                    ) ;
...
function save_array_to_basepress_dataset(
    ...
    $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressDatasets\save(
                    $basepress_dataset_handle   ,
                    $array_to_save              ,
                    $record_id
                    ) ;
