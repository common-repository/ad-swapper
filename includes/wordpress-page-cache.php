...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_wordpressPageCache ;
...
function get_time_to_live() {
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_wordpressPageCache\get_time_to_live()
    // - - - - - - - - - - - - - - - - - - - - - - -
...
function get_table_name() {
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_wordpressPageCache\get_table_name()
    // - - - - - - - - - - - - - - - - - - - - - - -
...
function get_page(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_wordpressPageCache\get_page(
    //      $page_name                      ,
    //      $page_key                       ,
    //      $question_session_specific      ,
    //      $question_remote_ip_specific    ,
    ...
    if (    ! is_string( $page_name )
            ...
            ||
            ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $page_name )
        ) {
    ...
    if (    ! is_string( $page_key )
            ...
            strlen( $page_key ) > 255
            ||
            ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $page_key )
        ) {
    ...
    if ( \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressMysql\table_exists( $page_cache_table_name ) !== TRUE ) {
        return '' ;
    }
...
EOT;
    ...
    $records = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressMysql\get_zero_or_more_records(
                    $sql
                    ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\dpbt() ;

//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $page_name ) ;
...
Detected in:&nbsp; \greatKiwi_byFernTec_adSwapper_local_v0x1x211_wordpressPageCache\set_page()
EOT;
...
EOT;
    ...
    if ( count( $records ) === 0 ) {
        ...
        $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressMysql\add_record(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressMysql\update_exactly_one_record_by_id(
        //      $table_name         ,
        //      $raw_record_data    ,
        //      $record_id
        //      )
...
//          'remote_user_agent'                 =>  $remote_user_agent  ,
        ...
        $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_basepressMysql\update_exactly_one_record_by_id(
                        $page_cache_table_name      ,
                        $raw_record_data            ,
                        $records[0]['id']
                        ) ;
