...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_urlUtils ;
...
// =============================================================================
// get_current_page_url_domain_only()
// =============================================================================

function get_current_page_url_domain_only(
    $question_die_on_error = FALSE
    ) {
    ...
    //
    // In other words, the returned URL will include the SCHEME, HOST and
    // possibly PORT parts - but NOT the PATH, QUERY or FRAGMENT.
    //
    // RETURNS
    //      o   On SUCCESS!
    //          -----------
    ...
    $question_domain_only = TRUE ;

    return get_current_page_url_inner(
                $question_domain_only       ,
                $question_die_on_error
                ) ;
...
// =============================================================================
// get_current_page_url_inner()
// =============================================================================

function get_current_page_url_inner(
    $question_domain_only  = FALSE      ,
    $question_die_on_error = FALSE
    ) {
    ...
    if ( isset( $_SERVER['HTTP_HOST'] ) ) {
        ...
        //
        //  Editor's note:  Using this code has security implications. The
        //                  client can set HTTP_HOST to any arbitrary value it
        //                  wants.
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $query_out ) ;
...
function is_url(
    ...
    require_once( dirname( __FILE__ ) . '/validata/url-validators.php' ) ;
