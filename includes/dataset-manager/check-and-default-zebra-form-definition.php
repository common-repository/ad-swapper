...
function check_and_default_zebra_form_definition(
    ...
    //
    //              // -----------------------------------------------------------------------------
    //              //  'form_field_value_from'    OPTIONAL
    //              //
    ...
    //              //      NOTE that:-
    //              //
    //              //      1.  You have to specify "form_field_value_from" separately, for the "add" and
    ...
    //              //              o   "button"
    //              //
    //              //          So there's NO need to specify "form_field_value_from" for fields with these
    //              //          control types.  And if you do specify "form_field_value_from", it will be
    //              //          IGNORED.
    //              //
    //              //      o   If specified, "form_field_value_from" should be like:-
    //              //
    //              //              array(
    //              //                  'add'   =>  array(
    //              //                                  'method'    =>  'array_storage_value_from'
    //              //                                  'instance'      =>  '<array storage field slug to get value from>'
    //              //                                                  //  (NULL or not specified means use "form_field_name")
    //              //                              -OR-
    //              //                                  'method'    =>  'literal' (The DEFAULT "add" value is the empty string)
    //              //                                  'instance'      =>  <some PHP (scalar) value>
    //              //                              -OR-
    //              //                                  'method'    =>  'function'
    //              //                                  'instance'      =>  array(
    ...
    //              //                                  )   ,
    //              //                  'edit'  =>  array(
    //              //                                  'method'    =>  'array_storage_value_from' (This is the DEFAULT)
    //              //                                  'instance'      =>  '<array storage field slug to get value from>'
    //              //                                                  //  (NULL or not specified means use "form_field_name")
    //              //                              -OR-
    //              //                              array(
    //              //                                  'method'    =>  'array_storage_field_value' (This is the DEFAULT)
    //              //                                  'instance'      =>  '<array storage field slug to get value from>'
    //              //                                                  //  (NULL or not specified means use "form_field_name")
    //              //                              -OR-
    //              //                                  'method'    =>  'literal'
    ...
    //              //                  )
    //              //
    //              //      o   If "form_field_value_from" - or any of it's components:-
    //              //              a)  ISN'T specified,
    //              //              b)  is NULL, or;
    ...
    //              //                                  'instance'      =>  <field's "form_field_name">
    //              //                                  )
    //              //                  )
    //              //
    //              // -----------------------------------------------------------------------------
...
EOT;
    ...
    if ( isset( $form_specs['name'] ) ) {
        ...
        if (    ! is_string( $form_specs['name'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $form_specs['name'] )
                ||
...
EOT;
    ...
    //      o   "form_field_value_from" is an array - with at least a "method" element.
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $selected_datasets_dmdd ) ;
    ...
    if (    function_exists( '\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\is_raw_mode_for_forms' )
            &&
            \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\is_raw_mode_for_forms() === TRUE
        ) {
    ...
    //          //                      'method'    =>  'function'
    //          //                      'instance'  =>  '<function name, including namespace prefix if necessary>'
    //          //                      'instance'      =>  (optional) If specified, should be either
    //          //                                      NULL or a possibly empty array.  NULL and
    //          //                                      not specified are converted to the empty
    //          //                                      array.
    //          //                      )
...
EOT;
        ...
        if (    ! is_string( $field_details['form_field_name'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_varname( $field_details['form_field_name'] )
                ||
        ...
        if ( isset( $field_details['label'] ) ) {
            ...
            if ( $field_details['label'] === NULL ) {
                ...
                $defaulted_field_details['label'] =
                    \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_title( $field_details['form_field_name'] )
                    ;
...
EOT;
        ...
        // -------------------------------------------------------------------------
        // check_and_default_form_field_value_from(
        //      $dataset_title                  ,
        //      $field_number                   ,
        //      $array_storage_field_slugs      ,
        //      $safe_form_slug_underscored     ,
        ...
        //      )
        // - - - - - - - - - - - - - - - - - - -
        // Defaults $field_details['form_field_value_from'] (and it's members) as required.
        //
        // RETURNS
        //      o   On SUCCESS
        //          TRUE
...
//          ) {
            ...
            $result = check_and_default_form_field_value_from(
                            $dataset_title                  ,
                            $field_number                   ,
                            $array_storage_field_slugs      ,
                            $safe_form_slug_underscored     ,
...
function check_and_default_form_field_value_from(
    $dataset_title                  ,
    $field_number                   ,
    $array_storage_field_slugs      ,
    $safe_form_slug_underscored     ,
...
//pr( $field_details ) ;
    ...
    if (    ! isset( $field_details['form_field_value_from'] )
            ||
            $field_details['form_field_value_from'] === NULL
            ||
            (   is_array( $field_details['form_field_value_from'] )
                &&
                count( $field_details['form_field_value_from'] ) === 0
                )
        ) {

        // ---------------------------------------------------------------------
        // Set the DEFAULT "form_field_value_from"...
        // ---------------------------------------------------------------------

        if ( ! in_array( $field_details['form_field_name'] , $array_storage_field_slugs , TRUE ) ) {

            return <<<EOT
PROBLEM: Can't default "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" - for field# {$field_number} (because there's NO "{$field_details['form_field_name']}" field in the array storage record)
For field:&nbsp; {$field_details['form_field_name']}
...
EOT;
        ...
        $field_details['form_field_value_from'] = array(
            'add'   =>  array(
                            'method'    =>  'literal'               ,
                            'instance'      =>  $default_when_adding
                            )   ,
            'edit'  =>  array(
                            'method'    =>  'array-storage-field-value'          ,
                            'instance'      =>  $field_details['form_field_name']
                            )
            ) ;
    ...
    // =========================================================================
    // "form_field_value_from" must be an ARRAY...
    // =========================================================================

    if ( ! is_array( $field_details['form_field_value_from'] ) ) {

        return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" - for field# {$field_number} (not an array)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    // -------------------------------------------------------------------------
    // check_and_default_form_field_value_from__method_and_args(
    //      $dataset_title                  ,
    //      $field_number                   ,
    //      $array_storage_field_slugs      ,
    //      $safe_form_slug_underscored     ,
    ...
    // - - - - - - - - - - - - - - - - - - -
    // Checks and defaults:-
    //      $field_details['form_field_value_from']['add'] or;
    //      $field_details['form_field_value_from']['edit']
    //
    ...
    // =========================================================================
    // "form_field_value_from" + "add"
    // =========================================================================

    if ( isset( $field_details['form_field_value_from']['add'] ) ) {
        ...
        $result = check_and_default_form_field_value_from__method_and_args(
                        $dataset_title                  ,
                        $field_number                   ,
                        $array_storage_field_slugs      ,
                        $safe_form_slug_underscored     ,
        ...
        $field_details['form_field_value_from']['add'] = array(
            'method'    =>  'literal'               ,
            'instance'      =>  $default_when_adding
            ) ;
    ...
    // =========================================================================
    // "form_field_value_from" + "edit"
    // =========================================================================

    if ( isset( $field_details['form_field_value_from']['edit'] ) ) {
        ...
        if ( ! in_array( $field_details['form_field_name'] , $array_storage_field_slugs , TRUE ) ) {
            ...
            return <<<EOT
PROBLEM: Can't default "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "edit" - for field# {$field_number} (because there's NO "{$field_details['form_field_name']}" field in the array storage record)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
        ...
        $field_details['form_field_value_from']['edit'] = array(
            'method'    =>  'array-storage-field-value'          ,
            'instance'      =>  $field_details['form_field_name']
            ) ;
...
function check_and_default_form_field_value_from__method_and_args(
    $dataset_title                  ,
    $field_number                   ,
    $array_storage_field_slugs      ,
    $safe_form_slug_underscored     ,
    ...
    //
    //          'add'   =>  array(
    //                          'method'    =>  'array-storage-value_from'
    //                          'instance'      =>  "xxx" (array storage field slug to get value from)
    //                      -OR-
    //                          'method'    =>  'literal' (The DEFAULT "add" value is the empty string)
    ...
    //
    //          'edit'  =>  array(
    //                          'method'    =>  'array-storage-value_from' (This is the DEFAULT)
    //                          'instance'      =>  "xxx" (array storage field slug to get value from)
    //                      -OR-
    //                          'method'    =>  'array-storage-field-value' (This is the DEFAULT)
    //                          'instance'      =>  "xxx" (array storage field slug to get value from)
    //                      -OR-
    //                          'method'    =>  'literal'
    //                          'instance'      =>  <some literal value>
    ...
    if ( ! is_array( $field_details['form_field_value_from'][ $add_edit ] ) ) {

        return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" - for field# {$field_number} (not an array)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    if ( ! isset( $field_details['form_field_value_from'][ $add_edit ]['method'] ) ) {

        return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" - for field# {$field_number} (no "method")
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    if (    ! is_string( $field_details['form_field_value_from'][ $add_edit ]['method'] )
            ||
            trim( $field_details['form_field_value_from'][ $add_edit ]['method'] ) === ''
        ) {

        return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "method" - for field# {$field_number} (non-empty string expected)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    if ( $field_details['form_field_value_from'][ $add_edit ]['method'] === 'array-storage-value-from' ) {

        // =====================================================================
        // METHOD = ARRAY-STORAGE-VALUE-FROM
        // =================================
        // "instance" is required and must be an "array-storage-field-slug"...
        // =====================================================================

        if (    $field_details['form_field_value_from'][ $add_edit ]['instance'] === NULL
                ||
                ! isset( $field_details['form_field_value_from'][ $add_edit ]['instance'] )
            ) {

            $field_details['form_field_value_from'][ $add_edit ]['instance'] =
        ...
        if (    ! isset( $field_details['form_field_value_from'][ $add_edit ]['instance'] )
                ||
                ! in_array( $field_details['form_field_value_from'][ $add_edit ]['instance'] , $array_storage_field_slugs , TRUE )
            ) {

            return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" - for field# {$field_number} ("args" is required - and must be an `array storage field slug`)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    } elseif ( $field_details['form_field_value_from'][ $add_edit ]['method'] === 'array-storage-field-value' ) {
...
EOT;
    ...
    } elseif ( $field_details['form_field_value_from'][ $add_edit ]['method'] === 'literal' ) {

        // =====================================================================
        // METHOD = LITERAL
        // ================
        // "instance" is required and must be a PHP SCALAR type...
        // =====================================================================

        if (    ! isset( $field_details['form_field_value_from'][ $add_edit ]['instance'] )
                ||
                ! is_scalar( $field_details['form_field_value_from'][ $add_edit ]['instance'] )
            ) {

            return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" - for field# {$field_number} (SCALAR value - ie; STRING, INT, BOOLEAN or FLOAT - expected)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    } elseif ( $field_details['form_field_value_from'][ $add_edit ]['method'] === 'function' ) {

        // =====================================================================
        // METHOD = FUNCTION
        // =================
        // "instance" is required and must be either:-
        //      o   A string (= the function name), or;
        //      o   A non-empty array...
        // =====================================================================

        if ( ! array_key_exists( 'instance' , $field_details['form_field_value_from'][ $add_edit ] ) ) {

            return <<<EOT
PROBLEM: No "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" - for field# {$field_number}
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
        ...
        if ( is_string( $field_details['form_field_value_from'][ $add_edit ]['instance'] ) ) {

            // -----------------------------------------------------------------
            // Function Name String Version ?
            // -----------------------------------------------------------------

            if ( trim( $field_details['form_field_value_from'][ $add_edit ]['instance'] ) === '' ) {

                return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" - for field# {$field_number} (function name string expected)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
            ...
            if ( ! function_exists( $field_details['form_field_value_from'][ $add_edit ]['instance'] ) ) {

                return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" - for field# {$field_number} (function not found)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
            ...
            if (    ! is_array( $field_details['form_field_value_from'][ $add_edit ]['instance'] )
                    ||
                    count( $field_details['form_field_value_from'][ $add_edit ]['instance'] ) < 1
                ) {

                return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" - for field# {$field_number} (non-empty array expected)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
            ...
            if ( ! array_key_exists( 'function_name' , $field_details['form_field_value_from'][ $add_edit ]['instance'] ) ) {

                return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" - for field# {$field_number} (no "function_name")
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
            ...
            if ( ! is_string( $field_details['form_field_value_from'][ $add_edit ]['instance']['function_name'] ) ) {

                return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" + "function_name" - for field# {$field_number} (function name string expected)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
            ...
            if ( ! function_exists( $field_details['form_field_value_from'][ $add_edit ]['instance']['function_name'] ) ) {

                return <<<EOT
PROBLEM: Bad "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "instance" + "function_name" - for field# {$field_number} (function not found)
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
            ...
            if ( ! array_key_exists( 'extra_args' , $field_details['form_field_value_from'][ $add_edit ]['instance'] ) ) {
                $field_details['form_field_value_from'][ $add_edit ]['instance']['extra_args'] = array() ;
            }
        ...
        return <<<EOT
PROBLEM: Unrecognised/unsupported "zebra_forms" + "{$safe_form_slug_underscored}" + "field_specs" + "form_field_value_from" + "{$add_edit}" + "method" - for field# {$field_number}
For field:&nbsp; {$field_details['form_field_name']}
Of form:&nbsp; {$safe_form_slug_underscored}
And dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
