...
function create_type_key_tree(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\create_type_key_tree(
    //      $type_key_list
    //      )
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $type_key_list ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $type_dash_key_list ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $this_data ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $type_dash_key_list[ $this_index ] ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $type_dash_keys_by_ancestor_count ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $type_key_tree ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $ancestry_by_type_key ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $this ) ;

//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $that ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $target_type_key ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $node ) ;
