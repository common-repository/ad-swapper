...
Detectd in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\manage_dataset_with_dhtmlx_grid()
EOT;
...
alert( a + ' --- ' + b + ' --- ' + order ) ;
    var retval = 0 ;
    if ( window.greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager_dhtmlxGrid_sortData['{$sort_slug}'][a] < window.greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager_dhtmlxGrid_sortData['{$sort_slug}'][b] ) {
        retval = -1 ;
    } else if ( window.greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager_dhtmlxGrid_sortData['{$sort_slug}'][a] > window.greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager_dhtmlxGrid_sortData['{$sort_slug}'][b] ) {
        retval = 1 ;
    }
alert( retval ) ;
    if ( order === 'asc' ) {
...
window.greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager_dhtmlxGrid_sortData = {$sort_data_js} ;
{$customSortFunctions}
EOT;
