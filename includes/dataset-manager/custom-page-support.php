...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_customPages ;
...
function load_custom_pages(
    ...
    // -----------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_dirsFiles\
    // super_scandir(
    //      $target_directory
    //      )
    // - - - - - - - - - - --
    ...
    $dirs_and_files =
        \greatKiwi_byFernTec_adSwapper_local_v0x1x211_dirsFiles\super_scandir(
            $target_apps_custom_pages_dir
            ) ;
...
EOT;
    ...
    foreach ( $dirs_and_files['dirs'] as $dir_basename => $dir_pathspec ) {
        ...
        if (    ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_dash(
                    $custom_page_name_slash_slug
                    )
                ||
