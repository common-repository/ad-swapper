...
//pr( $this_array_storage_field ) ;
        ...
        $columns_titles_by_field_slug[ $this_array_storage_field['slug'] ] =
            \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_title( $this_array_storage_field['slug'] )
            ;
...
{$inner_comma}<td><a
    ...
    onclick="greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager_questionDeleteRecord(this,'{$this_dataset_record[ $key_field_slug ]}')"
    >delete</a></td>
EOT;
