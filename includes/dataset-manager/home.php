...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $dataset_manager_dataset_defs_dir , '$dataset_manager_dataset_defs_dir' ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $_GET , '$_GET' ) ;
        ...
        $allowed_standard_actions = array(
            ...
            'add-record'        =>  array(
                                        ...
                                        'function_name' =>  '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\add_edit_record'   ,
                                        'object_type'   =>  'dataset'
                                        )   ,
            ...
            'delete-record'     =>  array(
                                        ...
                                        'function_name' =>  '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\delete_record'     ,
                                        'object_type'   =>  'dataset'
                                        )   ,

            'show-view'         =>  array(
                                        'basename'      =>  'show-view.php'                                         ,
                                        'function_name' =>  '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\show_view'         ,
                                        'object_type'   =>  'view'
                                        )
        ...
        if ( $question_home_page_raw_mode === TRUE ) {
            ...
            $allowed_standard_actions['view-raw'] = array(
                ...
                'function_name' =>  '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\view_raw'     ,
                'object_type'   =>  'dataset'
                ) ;

            $allowed_standard_actions['export-raw'] = array(
                'basename'      =>  'home-page-raw-mode-support/export-raw.php'                                     ,
                'function_name' =>  '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\export_raw'     ,
                'object_type'   =>  'dataset'
                ) ;

            $allowed_standard_actions['import-raw'] = array(
                'basename'      =>  'home-page-raw-mode-support/import-raw.php'                                     ,
                'function_name' =>  '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\import_raw'     ,
                'object_type'   =>  'dataset'
                ) ;
...
EOT;
    ...
    // =========================================================================
    // Was a CUSTOM HOME PAGE specified ?
    //
    // If so, display it...
    //
    // ----
    //
    // A custom home page was specfied if the FILE:-
    //
    //      <plugin-root-dir>/
    //      +-- app-defs/
    //          +-- <this-app's-".app"-dir/
    ...
    //
    // exists.  And if once that file has been required/included, the FUNCTION:-
    //
    ...
    //
    // For:-
    //      $_GET['page'] === "pluginPlant"
    //
    // we just show a LINK to the application's custom home page (if the
    // application has one).
    // =========================================================================
    ...
    if (    $_GET['page'] !== 'pluginPlant'
            ||
            (   array_key_exists( 'force_chp' , $_GET )
                &&
                $_GET['force_chp'] === 'true'
                )
        ) {
        ...
        if ( is_file( $custom_home_page_filespec ) ) {
            ...
            if ( function_exists( $custom_home_page_function_name ) ) {
                ...
                $result = $custom_home_page_function_name(
                                $core_plugapp_dirs                                  ,
                                $question_front_end                                 ,
                                $app_defs_directory_tree                            ,
                                $applications_dataset_and_view_definitions_etc      ,
                ...
                if ( $result !== FALSE ) {
                    ...
                    $msg = <<<EOT
PROBLEM:&nbsp; Unrecognised/unsupported custom home page function return value (FALSE expected)
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
...
//      $action_fn = '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\' . $action_name_with_underscores ;
...
//pr( $_GET ) ;
    ...
    $safe_dataset_title = htmlentities( \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_title( $_GET['dataset_slug'] ) ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $custom_pages ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $the_custom_page ) ;
...
EOT;
    ...
    $page_display_routine =
        '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_' .
        \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_camel_case(
            $_GET['custom_page']
            ) .
        '\\get_page_html'
        ;
