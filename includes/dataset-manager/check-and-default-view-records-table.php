...
For view:&nbsp; {$view_title}
Detected in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\check_and_default_view_records_table()
EOT;
...
EOT;
            ...
            if (    ! is_string( $this_column_def['base_slug'] )
                    ...
                    ||
                    ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_varname( $this_column_def['base_slug'] )
                    ||
...
EOT;
            ...
            if (    ! is_string( $this_column_def['raw_value_from']['method'] )
                    ...
                    ||
                    ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $this_column_def['raw_value_from']['method'] )
                    ||
...
EOT;
        ...
        if (    ! is_string( $view_records_table['table_header_before_iframe']['method'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $view_records_table['table_header_before_iframe']['method'] )
            ) {
...
EOT;
        ...
        if (    ! is_string( $view_records_table['table_footer_after_iframe']['method'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $view_records_table['table_footer_after_iframe']['method'] )
            ) {
...
EOT;
        ...
        if (    ! is_string( $view_records_table['table_header_in_iframe']['method'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $view_records_table['table_header_in_iframe']['method'] )
            ) {
...
EOT;
        ...
        if (    ! is_string( $view_records_table['table_footer_in_iframe']['method'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $view_records_table['table_footer_in_iframe']['method'] )
            ) {
