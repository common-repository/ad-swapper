...
For View:&nbsp; {$view_title}
Detected in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\\show_view_with_wp_list_table()
EOT;
...
//      }
    ...
    if (    array_key_exists( 'rows_per_page' , $selected_views_definition['view_records_table'] )
            &&
            is_scalar( $selected_views_definition['view_records_table']['rows_per_page'] )
            &&
            ctype_digit( (string) $selected_views_definition['view_records_table']['rows_per_page'] )
            &&
            $selected_views_definition['view_records_table']['rows_per_page'] > 0
        ) {
