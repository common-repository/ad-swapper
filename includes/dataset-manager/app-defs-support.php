...
EOT;
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_dirsFiles\load_directory_tree(
    //      $root_dir
    //      )
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    $tree = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_dirsFiles\load_directory_tree(
                $tree_root_dir
                ) ;
...
//pr( $tree_root_dirspec ) ;
    ...
    if ( in_array( 'app-data.php' , $tree['files'] , TRUE ) ) {
        ...
        $app_title = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_title( $app_slug ) ;
...
//pr( $app_data ) ;
    ...
    foreach ( $tree['dirs'] as $this_dirspec => $this_dirs_subtree ) {
        ...
        if ( \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ends_with(
    ...
    foreach ( $tree['files'] as $this_basename ) {
        ...
        if ( ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ends_with( $this_basename , '.dd.php' , $ignore_case_FALSE ) ) {
            continue ;
        }
...
//              '\\get_dataset_details'
//              ;
        $function_name =   '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_datasetDef_' .
                $dataset_title_camel_case .
                '\\get_dataset_details'
                ;
...
EOT;
    ...
    foreach ( $tree['files'] as $this_basename ) {
        ...
        if ( ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ends_with( $this_basename , '.view.php' , $ignore_case_FALSE ) ) {
            continue ;
        }
...
//              ;
        ...
        $view_slug_camel_case = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_camel_case( $view_slug ) ;

        $function_name =   '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_viewDef_' .
...
EOT;
    ...
    if (    \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ends_with(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_customPages\
        // load_custom_pages(
        //      $core_plugapp_dirs      ,
        //      $app_defs_dir
        //      )
        ...
        $custom_pages =
            \greatKiwi_byFernTec_adSwapper_local_v0x1x211_customPages\load_custom_pages(
                $core_plugapp_dirs      ,
                $tree_root_dirspec
                ) ;
