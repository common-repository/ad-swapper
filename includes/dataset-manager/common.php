...
function get_page_header(
    ...
    if (    array_key_exists( 'action' , $_GET )
        ...
        if (    $app_title
            ...
            $app_href = \untrailingslashit( \admin_url() ) . <<<EOT
?page={$_GET['page']}&application={$_GET['application']}
EOT;
...
<h3><a  href="{$href}"
        style="text-decoration:none"
        >{$GLOBALS['GREAT_KIWI']['STANDARD_DATASET_MANAGER']['calling_application_title']}</a> {$app} &raquo; {$page_title}</h3>
EOT;
...
<h3><a  href="{$href}"
        style="text-decoration:none"
        >{$GLOBALS['GREAT_KIWI']['STANDARD_DATASET_MANAGER']['calling_application_title']}</a> {$app} &raquo; <a
...
EOT;
    ...
    if (    ! is_array( $selected_datasets_dmdd )
            ||
            count( $selected_datasets_dmdd ) < 1
        ) {

        $msg = <<<EOT
PROBLEM: Bad dataset definition (non-empty array expected)
For dataset slug:&nbsp; "{$dataset_slug}"
In:&nbsp: "\$all_application_dataset_definitions"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    return get_dataset_key_field_slug_from_selected_datasets_dmdd(
                $selected_datasets_dmdd     ,
                $dataset_title
                ) ;
...
// =============================================================================
// get_dataset_key_field_slug_from_selected_datasets_dmdd()
// =============================================================================

function get_dataset_key_field_slug_from_selected_datasets_dmdd(
    $selected_datasets_dmdd     ,
    $dataset_title
    ) {
...
EOT;
    ...
    $key_field_slug = $selected_datasets_dmdd['array_storage_key_field_slug'] ;
    ...
    if (    ! is_string( $key_field_slug )
            ...
            trim( $key_field_slug ) === ''
            ||
            ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_varname( $key_field_slug )
            ||
            strlen( $key_field_slug ) > 64
        ) {

        $msg = <<<EOT
PROBLEM: Bad "array_storage_key_field_slug" (a max. 64 character, variable name like string was expected)
For dataset:&nbsp; {$dataset_title}
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
...
EOT;
    ...
    return \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_title( $dataset_slug ) ;
...
EOT;
    ...
    $result =
        \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\get_dataset_key_field_slug_and_record_indices_by_key(
            $all_application_dataset_definitions    ,
            $dataset_slug                           ,
            $dataset_title                          ,
            $dataset_records
...
function question_add_to_loaded_datasets(
    $all_application_dataset_definitions    ,
    $dataset_slug                           ,
    &$loaded_datasets
    ) {
...
*/
        ...
        require_once(
            \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugins_includes_dir( __FILE__ ) .
            '/url-utils.php'
            ) ;
        ...
        $cancel_href = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_urlUtils\get_query_adjusted_current_page_url(
                            $query_changes              ,
                            $question_amp               ,
                            $question_die_on_error
                            ) ;
...
EOT;
        ...
        if (    isset( $_GET['return_to'] )
            ...
            $cancel_href = \untrailingslashit( \admin_url() ) . <<<EOT
...
function get_add_dataset_record_button(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\get_add_dataset_record_button(
    //      $caller_apps_includes_dir       ,
    //      $question_front_end             ,
    //      $dataset_slug                   ,
    //      $record_type_title              ,
    ...
    if ( $question_front_end ) {
        ...
        $url = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_urlUtils\get_query_adjusted_current_page_url(
                    $query_changes              ,
                    $question_amp               ,
                    $question_die_on_error
                    ) ;
...
EOT;
        ...
        if (    ! is_string( $custom_action_details['slug'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore_dash( $custom_action_details['slug'] )
            ) {
...
function load_dataset_definitions(
    $core_plugapp_dirs                      ,
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $core_plugapp_dirs ) ;
...
//  require_once( $core_plugapp_dirs['dataset_manager_includes_dir'] . '/common.php' ) ;
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\load_app_defs_tree(
    //      $caller_app_slash_plugins_global_namespace      ,
    //      $caller_apps_includes_dir                       ,
    //      $question_front_end                             ,
    //      $tree_root_dir                                  ,
    ...
    $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\load_app_defs_tree(
                    $caller_app_slash_plugins_global_namespace      ,
...
//pr( $applications_dataset_and_view_definitions_etc ) ;
    ...
    $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\get_application_dataset_definitions(
                    $applications_dataset_and_view_definitions_etc   ,
                    $target_app_path
                    ) ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $all_application_dataset_definitions ) ;
...
function load_dataset_definitions_and_initialise_array_storage(
    ...
    // =========================================================================
    // Initialise the ARRAY STORAGE...
    // =========================================================================

    require_once( $core_plugapp_dirs['plugins_includes_dir'] . '/array-storage.php' ) ;

    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_arrayStorage\init(
    ...
    $result = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_arrayStorage\init(
                    $default_storage_method     ,
                    $json_data_files_dir        ,
                    $supported_datasets
                    ) ;
...
// =============================================================================
// load_applications_array_stored_datasets()
// =============================================================================

function load_applications_array_stored_datasets(
    $target_apps_apps_dir_relative_path     ,
    ...
    //      )
    // - - - - - - - - - - - - - - - - - - - - - - -
    // This is the main routine for loading an application/plugin's dataset
    ...
    // NOTE!
    // =====
    // 1.   All the datasets are assumed to use ARRAY STORAGE (not MySQL).
    // 2.   ALL the records from ALL the application/plugins datasets are
    //      loaded.
    //
    // RETURNS
    //      o   On SUCCESS
    ...
    // =========================================================================
    // Get the CORE PLUGAPP DIRS (if necessary)...
    // =========================================================================
    ...
    if ( ! is_array( $core_plugapp_dirs ) ) {
        ...
        $app_handle = $target_apps_apps_dir_relative_path ;
    ...
    // =========================================================================
    // Load the datset definitions (and initialise array storage)...
    // =========================================================================
    ...
    $result =
        \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\load_dataset_definitions_and_initialise_array_storage(
            $core_plugapp_dirs                      ,
            $target_apps_apps_dir_relative_path     ,
            $question_front_end
            ) ;
    ...
    // =========================================================================
    // Load ALL the applications dataset's...
    // =========================================================================
    ...
    foreach ( $all_application_dataset_definitions as $dataset_slug => $selected_datasets_dmdd ) {
...
function is_dataset_slug(
    ...
    if (    ! is_string( $candidate_dataset_slug )
            ...
            ||
            ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore( $candidate_dataset_slug )
        ) {
...
function is_field_slug(
    ...
    if (    ! is_string( $candidate_field_slug )
            ...
            ||
            ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore( $candidate_field_slug )
        ) {
...
function load_and_initialise_array_storage(
    ...
    return \greatKiwi_byFernTec_adSwapper_local_v0x1x211_arrayStorage\init(
                $default_storage_method     ,
                $json_data_files_dir        ,
                $supported_datasets
                ) ;
...
function load_dataset(
    ...
    if (    ! is_string( $dataset_title )
        ...
        $dataset_title = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\to_title( $dataset_slug ) ;
    }
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $dataset_key_field_slug , '$dataset_key_field_slug' ) ;

    if ( ! is_array( $record_indices_by_key ) ) {

        // ---------------------------------------------------------------------
        // Record indices AREN'T required for MySQL tables...
        // ---------------------------------------------------------------------
...
function orphaned_records_supported(
    ...
    $core_plugapp_dirs =
        \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_core_plugapp_dirs_base(
            $path_in_plugin     ,
            $app_handle
            ) ;
    ...
    if (    ! function_exists( '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_pluginMaker\\get_all_version_names' )
            ||
            ! function_exists( '\\greatKiwi_byFernTec_adSwapper_local_v0x1x211_pluginMaker\\get_version_name' )
        ) {
        return TRUE ;
    }
    ...
    $version_names = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_pluginMaker\get_all_version_names() ;

    $plugin_version_name = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_pluginMaker\get_version_name() ;

//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $version_names ) ;
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $plugin_version_name ) ;
...
function get_dataset_specific_default_record_data(
    $core_plugapp_dirs                      ,
    $all_application_dataset_definitions    ,
    $selected_datasets_dmdd                 ,
    $dataset_records                        ,
    ...
    if (    ! array_key_exists( 'default_record_functions_namespace_name' , $selected_datasets_dmdd )
            ||
            ! is_string( $selected_datasets_dmdd['default_record_functions_namespace_name'] )
            ||
            trim( $selected_datasets_dmdd['default_record_functions_namespace_name'] ) === ''
        ) {
    ...
    // =========================================================================
    // Does the "get_default_record_data()" function exist ?
    // =========================================================================

    $get_default_record_data_function_name =
        '\\' .
        $default_record_functions_namespace_name .
        '\\get_default_record_data'
        ;
    ...
    if ( ! function_exists( $get_default_record_data_function_name ) ) {
        ...
        return <<<EOT
PROBLEM:&nbsp; "get_default_record_data()" function not found
In "default_record_functions_namespace_name" = {$default_record_functions_namespace_name}
For dataset:&nbsp; "{$dataset_title}"
Detected in:&nbsp; \\{$ns}\\{$fn}()
EOT;
    ...
    return $get_default_record_data_function_name(
                $core_plugapp_dirs                      ,
                $all_application_dataset_definitions    ,
                $selected_datasets_dmdd                 ,
                $dataset_records                        ,
...
function get_blank_record(
    ...
    if (    ! is_array( $record_indices_by_key )
            ||
            count( $record_indices_by_key ) !== count( $dataset_records )
        ) {

        $record_indices_by_key = array() ;

        foreach ( $dataset_records as $this_index => $this_record ) {
            $record_indices_by_key[ $this_record['key'] ] = $this_index ;
        }
