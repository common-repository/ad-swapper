...
Detected in:&nbsp; \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\get_check_form_slug_underscored()
EOT;
...
EOT;
    ...
    foreach ( $selected_datasets_dmdd['zebra_forms'] as $candidate_form_name_underscored => $candidate_form_definition ) {
        ...
        if (    ! is_string( $candidate_form_name_underscored )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore( $candidate_form_name_underscored )
            ) {
...
EOT;
    ...
    if ( array_key_exists( 'form_slug_underscored' , $display_options ) ) {
        ...
        if (    ! is_string( $display_options['form_slug_underscored'] )
                ...
                ||
                ! \greatKiwi_byFernTec_adSwapper_local_v0x1x211_stringUtils\ctype_alphanumeric_underscore( $display_options['form_slug_underscored'] )
            ) {
