...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_wpMediaLibraryUtils ;
...
function get_smallest_as_big_as(
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_wpMediaLibraryUtils\
    // get_smallest_as_big_as(
    //      $target_media_library_image_url     ,
    //      $min_width                          ,
    //      $min_height
...
function get_smallest_as_big_as_data() {
    ...
    $global_cache_variable_name =
        'greatKiwi_byFernTec_adSwapper_local_v0x1x211_smallestAsBigAsData'
        ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $attachments , '$attachments' ) ;
