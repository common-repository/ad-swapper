...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI ;
...
//if ( ! function_exists( 'get_plugin_root_dir' ) ) {
    ...
    function get_plugin_root_dir(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugin_root_dir( $path_in_plugin )
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Detected in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\\get_plugin_root_dir()
EOT;
...
//if ( ! function_exists( 'convert_root_relative_plugin_pathspec_2_absolute' ) ) {
    ...
    function convert_root_relative_plugin_pathspec_2_absolute(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\convert_root_relative_plugin_pathspec_2_absolute(
        //      $path_in_plugin             ,
        //      $root_relative_pathspec
        //      )
        // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Detected in:&nbsp; \\greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\\convert_root_relative_plugin_pathspec_2_absolute()
EOT;
...
//if ( ! function_exists( 'get_plugins_app_defs_dir' ) ) {
    ...
    function get_plugins_app_defs_dir(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugins_app_defs_dir(
        //      $path_in_plugin
        //      )
        // - - - - - - - - - - - - - - - - - - - - - -
        ...
        // one uses __FILE__ for this purpose.  Eg:-
        //
        //      \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugins_app_defs_dir( __FILE__ ) ;
        //
...
//if ( ! function_exists( 'get_plugins_includes_dir' ) ) {
    ...
    function get_plugins_includes_dir(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugins_includes_dir(
        //      $path_in_plugin
        //      )
        // - - - - - - - - - - - - - - - - - - - - - -
        // Returns the dirspec of the root of the directory tree in which the
...
//if ( ! function_exists( 'get_single_apps_dot_app_dir' ) ) {
    ...
    function get_single_apps_dot_app_dir(
        ...
        // -------------------------------------------------------------------------
        // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_single_apps_dot_app_dir(
        //      $path_in_plugin
        //      $app_handle
        //      )
        // - - - - - - - - - - - - - - - - - - - - - - -
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( \gettype( $app_handle ) ) ;
...
//  if ( ! isset( $GLOBALS['GREAT_KIWI']['BY_FERN_TEC']['_adSwapper_local_']['_v0x1x211_']['core_plugapp_dirs'] ) ) {
//
//      $GLOBALS['GREAT_KIWI']['BY_FERN_TEC']['_adSwapper_local_']['_v0x1x211_']['core_plugapp_dirs'] =
//          get_core_plugapp_dirs_base(
//              $path_in_plugin     ,
//              $app_handle
//              ) ;
...
//  // -------------------------------------------------------------------------
//
//  return $GLOBALS['GREAT_KIWI']['BY_FERN_TEC']['_adSwapper_local_']['_v0x1x211_']['core_plugapp_dirs'] ;
...
// =============================================================================
// get_plugin_dot_stuff_dir_url()
// =============================================================================

function get_plugin_dot_stuff_dir_url() {
