...
// *****************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug ;
...
//pr( \debug_backtrace() ) ;
        ...
        echo <<<EOT
<p style="height:20px; background-color:#000000; margin-right:2em"></p>
EOT;

        // ---------------------------------------------------------------------

        $count_varname = 'greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug_debugPrintBacktrace_numberOnPage' ;

        if ( array_key_exists( $count_varname , $GLOBALS ) ) {
            $GLOBALS[ $count_varname ] = $GLOBALS[ $count_varname ] + 1 ;

        } else {
            $GLOBALS[ $count_varname ] = 1 ;
...
<tr>
    ...
    <td>{$ns}\\<br />&nbsp;&nbsp;&nbsp;&nbsp;<b style="font-size:120%">{$fn}</b></td>
</tr>
EOT;
...
<a  href="javascript:void()"
    onclick="greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug_toggleArgs({$GLOBALS[ $count_varname ]},{$this_depth})"
    style="text-decoration:none; font-weight:bold"
    >toggle {$number_args} args</a>
<div    id="greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug_args_{$GLOBALS[ $count_varname ]}_{$this_depth}"
        style="display:none; max-height:500px; overflow:auto; max-width:800px"
        >{$args}</div>
EOT;
...
<script type="text/javascript">
    function greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug_toggleArgs( number_on_page , depth ) {
        var id = 'greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug_args_' + number_on_page + '_' + depth ;
