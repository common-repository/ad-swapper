...
// ***************************************************************************
    ...
    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_shortcodes ;
...
//ob_start() ;
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $selected_gadget ) ;
//return ob_get_clean() ;
...
EOT;
    ...
    $plugin_slug_dashed = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugin_slug_dashed() ;
...
//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $app_handle ) ;
    ...
    $core_plugapp_dirs = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_core_plugapp_dirs(
                                $path_in_plugin     ,
                                $app_handle
                                ) ;
...
// =============================================================================
    ...
    add_shortcode(
        'teaser_maker_local_v0x1x211'           ,
        '\\' . __NAMESPACE__ . '\\main_shortcode_handler'
        ) ;

//\greatKiwi_byFernTec_adSwapper_local_v0x1x211_testDebug\pr( $GLOBALS['shortcode_tags'] ) ;
...
//  $plugin_dataset_defs_dir = $plugin_root_dir . '/dataset-manager-dataset-defs' ;
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\page_controller_wordpress_front_end(
...
//  $application_title = 'Research Assistant' ;
    $application_title = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugin_title() ;
    ...
    return \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\page_controller_wordpress_front_end(
