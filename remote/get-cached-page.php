...
//  $app_slash_plugin_unique_name = $fn() ;
    ...
    $app_slash_plugins_unique_dashed_name =
        \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_plugin_slug_dashed()
        ;
...
EOT;
    ...
    $page_content = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_wordpressPageCache\get_page(
                        $_GET['page_name']                              ,
                        $page_key                                       ,
