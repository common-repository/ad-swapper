...
// *****************************************************************************
// AD-SWAPPER.APP / PLUGIN-STUFF / ADMIN / HOME.PHP
// (C) 2014 Peter Newman. All Rights Reserved.
// *****************************************************************************

    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_adminSection ;
...
//\pluginPlant_byFernTec_private\pr( $_GET ) ;
    ...
    if (    ! isset( $_GET['page'] )
            ||
            $_GET['page'] !== 'adSwapperLocalV0x1x211'
        ) {
        return ;
    }
...
//    require_once( dirname( __FILE__ ) . '/common.php' ) ;
    ...
    $core_dirs = \greatKiwi_byFernTec_adSwapper_local_v0x1x211_appsAPI\get_core_plugapp_dirs(
                    $path_in_plugin     ,
                    $app_handle
                    ) ;
    ...
    //
    //          [plugin_root_dir]               =>
    //              /opt/lampp/htdocs/plugdev/wp-content/plugins/ad-swapper-v0.1
    //
    //          [plugins_includes_dir]          =>
    //              /opt/lampp/htdocs/plugdev/wp-content/plugins/ad-swapper-v0.1/includes
    //
    //          [plugins_app_defs_dir]          =>
    //              /opt/lampp/htdocs/plugdev/wp-content/plugins/ad-swapper-v0.1/app-defs
    //
    //          [dataset_manager_includes_dir]  =>
    //              /opt/lampp/htdocs/plugdev/wp-content/plugins/ad-swapper-v0.1/includes/dataset-manager
    //
    //          [apps_dot_app_dir]              =>
    //              /opt/lampp/htdocs/plugdev/wp-content/plugins/ad-swapper-v0.1/app-defs/ad-swapper-central.app
    //
    //          [apps_plugin_stuff_dir]         =>
    //              /opt/lampp/htdocs/plugdev/wp-content/plugins/ad-swapper-v0.1/app-defs/ad-swapper-central.app/plugin.stuff
    //
    //          )
    //
    // -------------------------------------------------------------------------
...
//pr( $core_dirs ) ;
    ...
    // -------------------------------------------------------------------------
    // \greatKiwi_byFernTec_adSwapper_local_pluginVersion_standardDatasetManager\page_controller_wordpress_back_end(
    ...
    $application_title = 'Ad Swapper  Local 0.1.211' ;

    $application_href  = '?page=adSwapperLocalV0x1x211' ;
    ...
    $wordpress_admin_page_query_variable_value = 'adSwapperLocalV0x1x211' ;

    // -------------------------------------------------------------------------

    \greatKiwi_byFernTec_adSwapper_local_v0x1x211_standardDatasetManager\page_controller_wordpress_back_end(
