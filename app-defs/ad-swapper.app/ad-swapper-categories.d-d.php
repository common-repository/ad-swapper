...
// *****************************************************************************
// AD-SWAPPER-CENTRAL.APP / AD-SWAPPER-CATEGORIES.DD.PHP
// (C) 2014 Peter Newman. All Rights Reserved.
// *****************************************************************************

    namespace greatKiwi_byFernTec_adSwapper_local_v0x1x211_datasetDef_adSwapperCategories ;
        //  NOTE!
        //  -----
...
//ini_set( 'display_errors' , '1' ) ;
    ...
    $basepress_dataset_uid =
        'e3e10ce4-d959-4da4-a22f-799f3d4885f5' . '-' .
        '47b2c215-e3fb-4ac6-b331-843c801d8066' . '-' .
        'ab2dafa0-2c4f-483c-9745-42a00d3ed33e' . '-' .
        '9fac1b1c-6d15-11e4-9184-9db61d5d46b0'
        ;

    // -------------------------------------------------------------------------

    $basepress_dataset_handle = array(
        'nice_name'     =>  'adSwapperCentral_byFernTec_categories'     ,
    ...
    $array_storage_record_structure = array(
        ...
        array(
            ...
            'array_storage_value_from'  =>  array(
                                                'add-edit'  =>  array(
                                                                    'method'    =>  'function'                                  ,
                                                                    'instance'  =>  '\\' . __NAMESPACE__ . '\\get_parent_key'   ,
                                                                    'args'      =>  NULL
                                                                    )
                                                )   ,
            'constraints'               =>  array(
...
//  }
    ...
    $zebra_form = array(
        ...
        'form_specs'    =>  array(
                                'name'                      =>  'add_edit_ad_swapper_category'  ,
                                'method'                    =>  'POST'                          ,
                                'action'                    =>  ''                              ,
                                'attributes'                =>  array()                         ,
...
//          )
    ...
    $dataset_details = array(
        'dataset_slug'                      =>  'ad_swapper_categories'             ,
        'dataset_name_singular'             =>  'ad_swapper_category'               ,
        'dataset_name_plural'               =>  'ad_swapper_categories'             ,
